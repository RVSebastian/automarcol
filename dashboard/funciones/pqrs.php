...
if (isset($_POST['rechazado']) or isset($_POST['atendido'])) {
    ...
    * {
    ...
    <p style="line-height: 160%; text-align: center; margin: 0px;"><span style="color: #2e3995; line-height: 44.8px; font-size: 28px;"><strong><span style="line-height: 44.8px;">PQRS #'.$id.' ATENDIDO</span></strong></span></p>
    </div>
    ...
    <img align="center" border="0" src="https://share1.cloudhq-mkt3.net/0b10a128a4ad73.gif" alt="" title="" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 650px;" width="650">
    ...
    <p style="line-height: 160%; text-align: justify !important; margin: 0px;color:  black !important;">'.$respuesta.'</p>
    <p style="line-height: 160%; text-align: justify; margin: 0px;">&nbsp;</p>
    <p style="line-height: 160%; text-align: justify; margin: 0px;">&nbsp;</p>
    </div>
